...
assert_func _csl_validate_parameters $TEST_OK $TEST_EMPTY

#CSL_WARNING_THRESHOLD=x
#CSL_CRITICAL_THRESHOLD=5
#assert_func _csl_validate_parameters $TEST_FAIL "warning parameter contains an invalid value"

#CSL_WARNING_THRESHOLD=5
#CSL_CRITICAL_THRESHOLD=x
#assert_func _csl_validate_parameters $TEST_FAIL "critical parameter contains an invalid value"
...
assert_func _csl_validate_parameters $TEST_FAIL "are mandatory"
